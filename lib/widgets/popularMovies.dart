// ignore_for_file: prefer_const_literals_to_create_immutables, prefer_const_constructors, unused_local_variable, unused_element, no_logic_in_create_state, must_be_immutable, prefer_interpolation_to_compose_strings, prefer_if_null_operators
...
class popularMovies extends StatefulWidget {
  ...
  @override
  _popularMovies createState() => _popularMovies();
}
...
class _popularMovies extends State<popularMovies> {
  ...
  loadMovies() async {
    ...
    List newReleases = newRelease['results'];
     ...
     if (mounted) {
    setState(() {
      PopularMovies = newRelease['results'];
    });
  }
  }
      ...
      children: [
        ...
        SingleChildScrollView(
            ...
            child: Row(
              ...
              children: [
                for (int i = 0; i <= PopularMovies.length - 1; i++)
                  InkWell(
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => MovieDetails(
                              ...
                              name: PopularMovies[i]['title'] != null
                                  ? PopularMovies[i]['title']
                                  : 'Loading',
                              details: PopularMovies[i]['overview'],
                              banner: 'http://image.tmdb.org/t/p/w500/' +
                                  PopularMovies[i]['backdrop_path'],
                              movieId: PopularMovies[i]['id'].toString(),
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                   ...
                                   Text(
                                  PopularMovies[i]['genre_ids'].length >= 2
                                      ? PopularMovies[i]['genre_ids']
                                          .sublist(0, 2)
                                          .join(" | ")
                                      : PopularMovies[i]['genre_ids']
                                              .isNotEmpty
                                          ? PopularMovies[i]['genre_ids'][0]
                                          : 'No genres available',
                                  overflow: TextOverflow.ellipsis,
                                  style: TextStyle(
                                    color: Colors.white54,
